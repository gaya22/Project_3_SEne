...
# Reading the introduction file to put in the dashboard
...
app.layout = html.Div(style={'backgroundColor': 'white'}, children=[
    ...
    dcc.Tabs(id='tabs', value='tab-1', children=[ # Container of tabs
        dcc.Tab(label='About this project', children=[ # First tab - introduction
            html.Div(children=[
                html.Pre(children=introduction, style={'whiteSpace': 'pre-wrap', 
                                                    'fontSize': '16px', 
        ...
        dcc.Tab(label='Natural gas data analysis', children=[ # Second tab - Data analysis
            html.Div(children=[
        ...
        dcc.Tab(label='Natural gas autocorrelation', children=[ # Third tab - Autocorrelation
            html.Div([
        ...
        dcc.Tab(label='Features analysis', children=[ # Fourth tab - Exploring features
            html.Div(children=[
        ...
        dcc.Tab(label='Italy data exploration', children=[ # Fifth tab - Italy data exploration
            html.Div([
                html.H2("Focus on Italy - exploring features"),
                html.P('Italy registered 12.8 GWh of electricity generated by natural gas during December 2022, that is the peak of Natural Gas usage for the electricity mix (57%).'),
                ...
                html.Div(children=[
                    html.Div(children=[ # Left part of the webpage containing the text
                        html.P('After a careful study of the selected data, the following considerations were drawn:'),
        ...
        dcc.Tab(label='Covid-19 and Russo-Ukrainian War impact on Italy data', children=[ # Sixth tab - 2020 changes
            html.Div([
                ...
                html.Div(children=[
                    ...
                    html.Div(children=[ # Right part of the webpage containing the result
                        ...
                        html.P('The blue line represents the real natural gas imports, while the red one is the forecast result. It can be seen that the Covid-19 event did not have consequences, but after February 2022 things took a different turn. '),

            ...
            html.Div([
                ...
                html.Div(children=[
                    ...
                    html.Div(children=[ # Right part of the webpage containing the result
                        ...
                        html.P('The blue line represents the real natural gas imports, while the red one is the forecast result. It can be seen that the Covid-19 event did not have consequences, but after February 2022 things took another direction than expected. '),

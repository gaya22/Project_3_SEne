# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 16:11:51 2023
    ...
    dcc.Tabs(id='tabs', value='tab-1', children=[
        ...
        dcc.Tab(label='Exploratory Data Analysis', value='tab-2', children=[
            html.Div([
                ...
                html.P('Here you can choose the variables you want to explore and the type of graph - scatterplot or boxplot!. The scatterplot tells us how different features are related while the boxplot is great for outliers!'),
                dcc.Dropdown(
                    id='feature1',
        ...
        dcc.Tab(label='Regression Models', value='tab-4', children=[
            html.Div([
                ...
                html.P('Select the type of model you want to train with the features you selected before. Press the button to generate the model '),
                dcc.Dropdown(
                    id='model-dropdown',
                    options=[
        ...
        dcc.Tab(label='Model Deployment', value='tab-6', children=[
            html.Div([
                ...
                html.P('Now lets depoly it. Press Run Model to generate the predictions for 2019 and the results will show up next to the real results. You can also see the error metrics'),
